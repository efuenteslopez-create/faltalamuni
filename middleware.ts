/**
 * FLM — Middleware de protección de rutas (equipo seguridad-qa-docs).
 *
 ...
 * Esto es intencional: el middleware corre en Edge y no tiene acceso al
 ...
 * no disponibles en Edge). Si cambia el nombre de la cookie, cambiar aquí.
 */
